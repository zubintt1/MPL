...
{
    public partial class ConferHallReserv_page1 : System.Web.UI.Page
    {
        ...
        protected void btn_submit3_Click(object sender, EventArgs e)
        {
            ...
            Int32 Timecount1;
            Int32 Timecount2;
            int.TryParse(txtbx_confertimefrom1.Text, out Timecount1);
            int.TryParse(txtbx_confertimeto1.Text, out Timecount2);
            bool Istime1correct = int.TryParse(txtbx_confertimefrom1.Text, out Timecount1);
            bool IsTime2correct = int.TryParse(txtbx_confertimeto1.Text, out Timecount2);
            ...
            if (Count2 > 0 && Count2 <= 4 && Ishallnumbercorrect == true && Istime1correct == true && IsTime2correct == true && Timecount1 < 2400 && Timecount2 < 2400 && Timecount1 < Timecount2)
            {
                ...
                data_store = new MySqlCommand("Select Count(*) from confer_reserv where confer_date1='" + txtbx_conferdate1.Text + "'", connect1);
                ...
                if (Count3 > 0 && Count6 > 0)
                {
                    ...
                    data_store = new MySqlCommand("Select Count(*) from confer_reserv where confer_date1='" + txtbx_conferdate1.Text + "' AND confer_time1 = '" + txtbx_confertimefrom1.Text + "'", connect1);
                    int Count4 = Convert.ToInt32(data_store.ExecuteScalar());
                    data_store.Dispose();

                    data_store = new MySqlCommand("Select Count(*) from confer_reserv where confer_date1='" + txtbx_conferdate1.Text + "' AND confer_time2 = '" + txtbx_confertimeto1.Text + "'", connect1);
                    int Count5 = Convert.ToInt32(data_store.ExecuteScalar());
                    data_store.Dispose();

                    if (Count4 > 0 && Count5 > 0)
                    {
                        lbl_error7.Visible = true;
                        lbl_booked1.Visible = false;
                        lbl_error8.Visible = false;
                    }
                    else if (Count4 == 0 && Count5 == 0)
                    {
                        ...
                        MySqlDataAdapter DAd2 = new MySqlDataAdapter("Select confer_time1,confer_time2 from confer_reserv where confer_date1 = '" + txtbx_conferdate1.Text.Trim() + "' and confer_hallno1 = '"+txtbx_conferhallnum1.Text.Trim()+"' order by confer_time1", connect1);
                        ...
                        for (i = 0;i <= timing.Tables[0].Rows.Count - 1; i++)
                        {
                            ...
                            while (Timecount1 < confer_starttime1 && Timecount2 <= confer_starttime1)
                            {
                                ...
                                "confer_department,confer_bookedby1) Values('" + txtbx_conferdate1.Text.Trim() + "','" + txtbx_confertimefrom1.Text.ToString().Trim() + "'," +
                                "'" + txtbx_confertimeto1.Text.Trim() + "','" + txtbx_conferhallnum1.Text.Trim() + "','" + thisUserID1.Trim() + "'," +
                ...
                else
                {
                    ...
                    data_store = new MySqlCommand("Insert InTo confer_reserv(confer_date1,confer_time1,confer_time2,confer_hallno1,confer_userid1," +
                    "confer_department,confer_bookedby1) Values('" + txtbx_conferdate1.Text.Trim() + "','" + txtbx_confertimefrom1.Text.Trim() + "'," +
                    "'" + txtbx_confertimeto1.Text.Trim() + "','" + txtbx_conferhallnum1.Text.Trim() + "','" + thisUserID1.Trim() + "'," +
                    "'" + thisuserdept1.Trim() + "','" + thisuserfullname1.Trim() + "')", connect1);
                    data_store.ExecuteNonQuery();
                    data_store.Dispose();
        ...
        {
            connect1.Open();
            DAd1 = new MySqlDataAdapter("Select confer_date1,confer_time1,confer_time2,confer_hallno1,confer_department from confer_reserv order by confer_time1", connect1);
            ds = new DataSet();
            DAd1.Fill(ds);
            grid_conferstatus.DataSource = ds;
            grid_conferstatus.DataBind();
            connect1.Close();

            grid_conferstatus.Visible = true;
        ...
        protected void btn_smbs1_Click(object sender, EventArgs e)
        {
            Response.Redirect("MyBookingStatus_page1.aspx");
        }
